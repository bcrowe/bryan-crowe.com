<div class="affix">
	<div id="photo">
		<img id="bryan" class="img-circle img-responsive" src="/img/bryan-crowe.jpg" />
	</div>
	...
	<div style="width: 155px; margin-top: 20px; text-align: center; color: #f8f8f8;">
		Bryan Crowe is a passionate, beer-drinking, idiotic, open source developer living in Pittsburgh, PA. He is interested in the CakePHP framework and probably has a mild form of adult autism and Tourette's syndrome.
	</div>
</div>