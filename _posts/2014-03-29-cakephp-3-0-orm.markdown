...
But, to aquaint an exposed "virtual field" in CakePHP 3.0, you would define an accessor method within your Entity, and expose it within the `$_virtual` property, such as:
